...
#점수를 받는 함수를 생성
def input_rating():
    file_path = 'user_item_matrix_with_imputation.csv'
    df = pd.read_csv(file_path)
    output_file_path = 'updated_user_item_matrix.xlsx'
    output_file_path2 = 'updated_user_item_matrix.csv'
